...
1. Использовать конкретные типы исключений
2. Предоставлять информативные сообщения
3. Не использовать исключения для контроля потока выполнения
4. Логгировать исключения перед их обработкой
5. Использовать `finally` для очистки ресурсов
